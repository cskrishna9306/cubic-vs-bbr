#!/bin/bash
# Create a new server on another instance with iperf3 -s -p 5201
# Use this script using the following command on the client:
# ./script-bt-results.sh $CCA-20ms-delay-f.txt & iperf3 -c SERVER_IP -p SERVER_PORT --cport CLIENT_PORT_1 -t $TIME -i 0.1 & wait
...
SERVER_PORT="46466"        # Replace with your server's port
CLIENT_IP="172.31.60.191"  # Replace with your client's IP
OUTPUT_FILE=$1
